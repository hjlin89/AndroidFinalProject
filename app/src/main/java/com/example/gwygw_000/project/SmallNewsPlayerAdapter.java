...
public class SmallNewsPlayerAdapter extends FirebaseRecyclerAdapter<News, SmallNewsPlayerAdapter.NewsSmallViewHolder> {

    private Context mContext ;
    static OnItemClickListener mItemClickListener;

    public SmallNewsPlayerAdapter(Class<News> modelClass, int modelLayout,
    ...
    protected void populateViewHolder(NewsSmallViewHolder newsSmallViewHolder, News news, int i) {
        ...
        newsSmallViewHolder.vTitle.setText(news.getPlayerID());
